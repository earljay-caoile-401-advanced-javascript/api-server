 ...
 * @param {object} Category.required - category object to add to the database
 ...
 * @returns {object} 204 - the deleted category object
 * @returns {Error} 500 - Unexpected error
 */
 ...
 * @param {string} id.path.required - the ID property of the individual category to update
 * @param {object} Product.required - object with properties to update existing product with
 * @returns {object} 200 - the updated category object
 * @returns {Error} 500 - Unexpected error
 */
 ...
 * @returns {object} 204 - the deleted product object
 * @returns {Error} 500 - Unexpected error
 */
