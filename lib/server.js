...
const basicAuth = require('./middleware/mock-auth.js');
...
app.post('/api/v1/categories', basicAuth, createCategory);
app.put('/api/v1/categories/:id', basicAuth, updateCategory);
app.delete('/api/v1/categories/:id', basicAuth, deleteCategory);
...
app.post('/api/v1/products', basicAuth, createProduct);
app.put('/api/v1/products/:id', basicAuth, updateProduct);
app.delete('/api/v1/products/:id', basicAuth, deleteProduct);
