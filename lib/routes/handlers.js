 ...
 * @param {string} displayName.query - categories matching the given displayName
 ...
 * @param {string} displayName.query - products matching the given displayName
...
handlers.patchRecord = (req, res, next) => {
  req.model
    .partiallyUpdate(req.params.id, req.body)
    .then((patchRes) => {
